...
class AStarPlanner:
    ...
    def __init__(self, ox, oy, resolution, rr, fc_x, fc_y, tc_x, tc_y, gc_x, gc_y):
        """
        ...
        self.Delta_C3 = 0.05 # cost saving area 1 modifier
...
def main():
    ...
    if show_animation:  # pragma: no cover
        ...
        plt.plot(gc_x, gc_y, "ob") # plot the cost saving area 1

        plt.grid(True) # plot the grid to the plot panel
        plt.axis("equal") # set the same resolution for x and y axis 

    a_star = AStarPlanner(ox, oy, grid_size, robot_radius, fc_x, fc_y, tc_x, tc_y, gc_x, gc_y)
