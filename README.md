...
In this project, I am reponsible for Task 1 and additional task A2. I also take part in writing the readme page. During the whole project, I realised the importance of teamwork. By allocating the task properly to groupmates with different talents, it'll increase the efficiency of the working process. For example, one of my groupmate has experience in coding so he focused on coding. Those who are not familiar with coding, they will do the report part. Proper division of labour has speed up our progress a lot.

At first, when I was trying to do task 1, I found it really difficult to edit the sample codes since I don't have any coding experience before. After reading the code and notes, I breifly understand the pattern and how the mechanism of the code. When I was editting the code, I encountered a problem. By changing the coordinates of the existing obstacles codes, I successfully placed the obstacle bar to the correct position of (30,50) and (40, 10). However, the slope of the bar is too steep so the obstacles points is too sparse and the path might pass through the obstacle bar. After asking other people, I realised that I could use an equation in term of x to generate the same obstacle bar with denser obstacle points. From this task, I acquired basic coding skills, and the most importantly, critical thinking. I found that by thinking in different ways, I can get a same result in a simplier and faster way. I believe this skill would be beneficial in my future study and career development.

Besides, in task A2, I have learnt to use AI to assist my work. In the era of AI, it is important to know how to implement AI into our work. This project provided an opportunity to let me use AI to assist my work. AI helped me to proofread and explain how does the code work. Additionally, AI provide some sample code to me for reference. With those samples, I could finish Task A2 gradually such as generating a random cost intensive area and obstacles even without any coding experience. By the task I realized the power of AI and how would it improve our efficiency.

To conclude, this project offered me a insight of how AI assist out work and a taste of coding. I believe this experience would be invaluable for my study in the future.
